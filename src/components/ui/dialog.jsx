...
/** modal=false تا react-remove-scroll بدنه را قفل نکند (پرش scrollbar). برای مودال سخت‌گیرانه می‌توان modal را true گذاشت. */
...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    {/* با modal=false اورلی رادیکس رندر نمی‌شود؛ این لایه فقط تیرگی است و pointer-events-none تا صفحه زیر اسکرول/کلیک شود */}
    <div aria-hidden className="pointer-events-none fixed inset-0 z-50 bg-black/80" />
