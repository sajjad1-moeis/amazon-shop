...
export default function Timeline({ currentStep = 1, steps = [] }) {
  ...
  return (
    <div className="relative mx-auto px-14 select-none flex items-start min-h-[100px] max-lg:min-w-[900px]">
      {/* خط پس‌زمینه */}
          ...
          return (
            ...
            >
              <div
                ...
                className="size-[52px] text-xl flex items-center justify-center bg-white dark:bg-dark-field rounded-full shadow-md transition-all duration-300"
              >
