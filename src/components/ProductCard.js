...
function ProductCard({ className }) {
  return (
    <div className={`border  rounded-xl p-2 lg:p-4 flex flex-col  ${className || "border-gray-200"}`}>
      ...
      <p className=" font-medium text-right leading-6 max-lg:text-sm mt-3">
        ساعت مچی مردانه Invicta مدل 0361 سری Reserve کرونوگراف
      </p>

      <div className="flex justify-between items-center  mt-4">
        <span className="font-bold text-neutral-800 max-lg:text-sm"> 12,450,000 تومان</span>
