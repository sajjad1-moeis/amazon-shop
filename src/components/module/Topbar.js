  ...
  return (
    <div className="bg-primary-500">
      <div className="bg-primary-800/20">
        <div className="w-full container  py-3 px-4 flex items-center justify-between text-white">
          {/* Right Section */}
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="gray" size="sm" className="relative rounded-xl px-3 py-1 flex items-center gap-2">
            ...
            <Button variant="gray" size="sm" className="rounded-xl px-3 py-1 flex items-center gap-2">
            ...
            <Button variant="gray" size="sm" className="rounded-xl  px-3 py-1 flex-between">
              مشاهده همه
              <ArrowLeft2 />
            </Button>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="ghost" className="flex items-center gap-2 rounded-xl px-3 py-1">
