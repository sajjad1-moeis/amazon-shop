      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4" dir="rtl">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 mt-5">
              پرداخت با موفقیت انجام شد
            </h1>
            <p className="text-gray-600 text-sm max-md:text-xs">سفارش شما با موفقیت ثبت شد و در حال پردازش است.</p>
          </div>

          {/* Main Content Card */}
          <div className="bg-white rounded-2xl shadow-sm p-4 md:p-8 space-y-6 mt-12 box-payment">
            {/* Introductory Text */}
            <p className="text-gray-500 leading-relaxed text-center text-sm max-md:text-xs">
            ...
            <div className="space-y-4 pt-4 border-t border-gray-200 text-center ">
              <label className="text-xs md:text-sm text-gray-500">مبلغ پرداختی</label>
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <div className="space-y-1 bg-gray-100 p-2 rounded-md">
                <label className="text-xs md:text-sm text-gray-500">کد تراکنش</label>
                <p className="text-sm md:text-base text-gray-900">{paymentData.transactionCode}</p>
              </div>
              <div className="space-y-1 bg-gray-100 p-2 rounded-md">
                <label className="text-xs md:text-sm text-gray-500">شماره سفارش</label>
                <p className="text-sm md:text-base text-gray-900">{paymentData.orderNumber}</p>
              </div>
              <div className="space-y-1 bg-gray-100 p-2 rounded-md">
                <label className="text-xs md:text-sm text-gray-500">روش پرداخت</label>
                <p className="text-sm md:text-base text-gray-900">{paymentData.paymentMethod}</p>
              </div>
              <div className="space-y-1 bg-gray-100 p-2 rounded-md">
                <label className="text-xs md:text-sm text-gray-500">تاریخ پرداخت</label>
                <p className="text-sm md:text-base text-gray-900">{paymentData.paymentDate}</p>
              </div>
            </div>
