...
// داده‌های تستی
const stats = [
  { title: "کل کاربران", value: "2,456", icon: Users, color: "text-blue-500", bgColor: "bg-blue-500/10", change: "+12.5%" },
  { title: "محصولات", value: "1,234", icon: ShoppingBag, color: "text-green-500", bgColor: "bg-green-500/10", change: "+8.2%" },
  { title: "سفارشات امروز", value: "89", icon: ShoppingCart, color: "text-purple-500", bgColor: "bg-purple-500/10", change: "+15.3%" },
  { title: "درآمد امروز", value: "12.5M", icon: DollarSign, color: "text-orange-500", bgColor: "bg-orange-500/10", change: "+22.1%" },
  { title: "درآمد ماهانه", value: "245M", icon: TrendingUp, color: "text-pink-500", bgColor: "bg-pink-500/10", change: "+18.7%" },
  { title: "محصولات موجود", value: "856", icon: Package, color: "text-cyan-500", bgColor: "bg-cyan-500/10", change: "+5.4%" },
];

const recentOrders = [
  { id: 1, customer: "علی محمدی", product: "لپ تاپ Dell", amount: 45000000, status: "در حال پردازش", date: "1403/09/20" },
  ...
  { id: 5, customer: "محمد صادقی", product: "تبلت iPad", amount: 55000000, status: "در حال پردازش", date: "1403/09/19" },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400">خوش آمدید به پنل مدیریت فروشگاه</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader>
            <CardTitle className="text-white">آخرین سفارشات</CardTitle>
