  ...
  return (
    <IndexLayout>
      <div className="bg-gray-50 pb-20 dark:bg-dark-bg">
        <Image
          src="/image/Blogs/blogBg.png"
          alt="بلاگ"
          width={1200}
          height={500}
          priority
          className="w-full h-auto mb-10 md:mb-20 md:min-h-[200px] object-cover"
        />
          ...
          <>
            ...
            <div className="grid lg:grid-cols-2 gap-5 container my-4 md:my-8">
              <div className="relative aspect-square max-h-40 md:max-h-[250px] w-full">
                <Image src="/image/Blogs/banner1.png" alt="بنر بلاگ" fill className="object-cover rounded-2xl" />
              </div>
              <div className="relative aspect-square max-h-40 md:max-h-[250px] w-full">
                <Image src="/image/Blogs/banner2.png" alt="بنر بلاگ" fill className="object-cover rounded-2xl" />
              </div>
            </div>
            ...
            <PaginationBlogs currentPage={pageNumber} totalPages={totalPages} onPageChange={setPageNumber} />
          </>
        )}
      </div>
    </IndexLayout>
