      ...
      <div className="mb-8">
        <div className="grid grid-cols-5 gap-6 mb-6">
          ...
          <div className="md:col-span-3 w-full">
            <h1 className="text-4xl font-bold text-primary-700 leading-[50px] text-right">
              چگونه از آمازون آمریکا خرید کنیم؟ (راهنمای کامل برای خریداران ایرانی)
            </h1>

            <div className="flex-between gap-6 text-sm text-gray-400 mb-4 mt-5 flex-wrap">
            ...
            <div class="border-t border-gray-200 pt-4 mt-4 text-gray-500">
              <p>
