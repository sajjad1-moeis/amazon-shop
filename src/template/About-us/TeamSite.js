    ...
    <div className="mt-10 md:mt-32 mb-20">
      <div className="container grid lg:grid-cols-3 gap-10 items-center">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="text-gray-600 dark:text-dark-text space-y-2 mt-6">
            <p>
          ...
          <p className="mt-3 text-primary-700 text-xl font-bold dark:text-primary-300">رضایت و اعتماد شما.</p>
        </div>
      </div>
    </div>
  );
