...
export default function OutletPageClient({ activeTab = "outlet" }) {
  ...
  return (
    <div dir="rtl">
      <DealsTopSection activeTab={activeTab} />
      <div className="container">
        <div className="mt-2 md:mt-4 grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6">
...
export default function OutletPageClient() {
  ...
  return (
    <div dir="rtl">
      <DealsTopSection activeTab="outlet" />
      <div className="container">
        <div className="mt-2 md:mt-4 grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6">
        <aside className="order-2 lg:order-1">
          <ProductsFilters
