...
import { Calendar, Calendar1, Like, Like1, Messages3, Star, Star1 } from "iconsax-reactjs";
...
export default function ExperienceModal({ open, onClose, experience, selectedImageIndex, setSelectedImageIndex }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="lg:max-w-5xl w-full p-0 gap-0 overflow-hidden rounded-2xl" dir="rtl">
        <div className="flex flex-col lg:flex-row-reverse">
          ...
          <div className="w-full lg:w-1/2 p-6 space-y-4 overflow-y-auto max-h-[80vh]">
            ...
            <div class="flex-between mt-2 pb-4  border-b text-xs text-gray-400">
            ...
            <div className="pb-4 mb-4 border-b">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">تجربه کامل:</h3>
              <p className="text-gray-700 leading-relaxed">{experience.description}</p>
            </div>
            <div className="max-lg:max-h-24  overflow-auto">
              <div class="flex-between">
                <h3 className=" text-gray-900 mb-3 ">لیست کامنت‌ها:</h3>
