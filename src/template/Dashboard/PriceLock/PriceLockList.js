          ...
          <TabsContent value="history" className="mt-6 space-y-4">
            <div className="bg-white dark:bg-dark-box rounded-2xl shadow-sm p-3">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <h2 className="text-lg text-gray-900 dark:text-dark-title">لیست اعلانها</h2>
          ...
          <TabsContent value="rules" className="mt-6 space-y-4">
            <div className="bg-white dark:bg-dark-box rounded-2xl shadow-sm p-6">
              <div className="space-y-6">
                {/* What is Price Lock? */}
                <div>
                  <h3 className="text-base font-bold text-gray-900 dark:text-dark-title mb-2">قفل قیمت چیست؟</h3>
                ...
                {/* Terms of Use */}
                <div>
                  <h3 className="text-base font-bold text-gray-900 dark:text-dark-title mb-2">شرایط استفاده</h3>
                ...
                {/* Lock Fee */}
                <div>
                  <h3 className="text-base font-bold text-gray-900 dark:text-dark-title mb-2">هزینه قفل</h3>
                  <p className="text-sm text-gray-600 dark:text-dark-text leading-relaxed">
                ...
                <div>
                  <h3 className="text-base font-bold text-gray-900 dark:text-dark-title mb-2">محصولات غیر قابل قفل</h3>
                  <p className="text-sm text-gray-600 dark:text-dark-text leading-relaxed">
