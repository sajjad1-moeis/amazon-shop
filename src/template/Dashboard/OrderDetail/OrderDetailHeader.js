      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <Button
            ...
            className="bg-gray-200 dark:bg-dark-field dark:text-red-400 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 gap-2 text-sm"
          >
            <X size={18} />
          ...
          <Button
            ...
            variant="outline"
            className="bg-primary-700 dark:bg-dark-primary rounded-lg text-white hover:bg-blue-50 dark:hover:bg-blue-900/20 gap-2 text-sm"
          >
            <ArrowDown size={18} />
