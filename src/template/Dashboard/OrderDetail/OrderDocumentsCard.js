      ...
      <div className="bg-white dark:bg-dark-box rounded-xl border border-gray-200 dark:border-dark-stroke p-3">
        <div className="flex items-center justify-between mb-4">
          ...
          <Button
            ...
            className="bg-primary-700 max-md:text-xs max-md:px-2 max-md:h-8 hover:bg-primary-800 dark:bg-dark-primary text-white rounded-lg gap-2 text-sm"
          >
            درخواست مستند خرید
          </Button>
        </div>
        ...
        {documents.length === 0 ? (
          <div className="flex items-center justify-center py-12">
            <p className="text-gray-400 dark:text-dark-text text-sm">برای این سفارش درخواست مستند ثبت نشده</p>
          </div>
        ) : (
