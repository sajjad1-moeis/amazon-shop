...
export default function ProductCard({ product, onCancelLock, onViewDetails }) {
  ...
  return (
    <>
      <p className="mt-6 mb-4 text-primary-800">محصول وارد شده</p>
      <div className="w-full bg-gray-50 dark:bg-dark-box rounded-xl p-2 border border-gray-200 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
        {/* Product Image */}
        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          <div className="flex-between">
            ...
            <div className="text-green-800 bg-green-100 px-2.5 py-1 text-sm rounded-md flex gap-2">
