...
function DirectPurchase() {
  return (
    <AboutServiceCard
      ...
      desc={
        <p>
          علی اکسپرس یکی از خرده‌فروشی‌های بزرگ چین است که به تنوع محصولات، فروشندگان و قیمت‌های متنوع معروف است. خرید
          از علی اکسپرس به صورت مستقیم برای ایرانیان میسر نیست، بنابراین برای خرید از علی اکسپرس به یک واسطه نیاز دارید؛
