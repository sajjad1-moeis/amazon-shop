      ...
      <div className="flex-between border-b pb-4 mb-4">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-1 text-xs md:text-sm">
            ...
            {(product?.reviewCount != null || product?.reviews_count != null) && (
        ...
        <div className="flex-center gap-2">
          {(product?.amazonUrl || product?.product_url) ? (
            <a
              href={product.amazonUrl || product.product_url}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-yellow-700 dark:text-yellow-600 text-xs hover:underline focus:outline-none focus:ring-2 focus:ring-amber-400 rounded"
            ...
            <span className="inline-flex items-center gap-2 text-yellow-700 dark:text-yellow-600 text-xs">
              <span>مشاهده در آمازون</span>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                <g clipPath="url(#clip0_170_5987_alt)">
                ...
                <defs>
                  <clipPath id="clip0_170_5987_alt">
                    <rect width="18" height="18" fill="white" />
                  </clipPath>
                </defs>
              </svg>
