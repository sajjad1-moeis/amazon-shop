...
export default function ShippingReturnPolicy() {
  ...
  return (
    <div className="max-md:text-sm">
      ...
      {/* Warning Box */}
      <div className="bg-gray-100 border border-gray-200 rounded-lg p-2 mt-4">
        <p className=" text-gray-700">
          ...
          <span className="text-yellow-600 max-md:underline md:text-primary-600">
      ...
      <div className="flex items-center gap-3 mt-12">
        ...
        <h2 className="text-xl md:text-2xl font-bold text-primary-600">شرایط کامل بازگشت کالا</h2>
      </div>

      {/* Section 1 */}
      <div className="space-y-3 mt-8">
        <h3 className="text-base md:text-lg text-gray-700">۱) چه کالاهایی قابل بازگشت هستند؟</h3>
      ...
      {/* Section 2 */}
      <div className="space-y-3 mt-8">
        <h3 className="text-base md:text-lg text-gray-700">۲) چه کالاهایی قابل بازگشت نیستند؟</h3>
        <p className="text-gray-600">طبق قوانین مرجع واقعی:</p>
        <ul className="space-y-2 text-gray-600 list-disc list-inside mt-3 max-md:text-sm">
      ...
      <div className="space-y-10 mt-8 md:mt-12 pt-12 border-t-2 border-gray-200">
        <div>
      ...
      {/* ----- لغو سفارش ----- */}
      <div className="mt-8 md:mt-12 pt-12 border-t-2">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-1 h-8 bg-primary-400 rounded-l"></div>
          <h2 className="text-xl md:text-2xl font-bold text-primary-600">لغو سفارش</h2>
        </div>
        ...
        <Accordion type="single" collapsible className="w-full space-y-3">
          {cancelOrderAccordion.map((item) => (
            <AccordionItem
              key={item.value}
              value={item.value}
              className="bg-gray-50 p-3 rounded-lg border-primary-200 border"
            >
              <AccordionTrigger className="p-0">{item.title}</AccordionTrigger>
              <AccordionContent className="text-gray-600 text-sm leading-6 mt-3">{item.content}</AccordionContent>
            </AccordionItem>
          ))}
        </Accordion>
      </div>
      ...
      <div className="mt-8 md:mt-12 pt-12 border-t-2">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-1 h-8 bg-primary-400 rounded-l"></div>
          <h2 className="text-xl md:text-2xl font-bold text-primary-600">بازپرداخت</h2>
        </div>
        <p className="text-gray-600 text-sm">بازپرداخت‌ها طی ۲ تا ۷ روز کاری پس از تایید کامل انجام می‌شود.</p>
      ...
      {/* هشدار نهایی */}
      <div className="text-sm text-primary-600 bg-primary-50 p-3 rounded-lg mt-4 flex items-center gap-2">
