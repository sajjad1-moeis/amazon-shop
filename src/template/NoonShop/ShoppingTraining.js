...
function ShoppingTraining() {
  return (
    <div className="container mt-28">
      ...
      <div className="max-md:text-sm md:text-lg text-gray-600 dark:text-dark-text">
        <p>
        ...
        <p>
          {" "}
          <span className="text-gray-800 font-bold dark:text-primary-400">گروه میکرولس</span> گزینه مناسبی برای خرید از
          noon می‌باشد. کافیست خریدار، لینک کالا یا نام محصولی که در سایت نون پیدا کرده است را در باکس بالا کپی نماید و
          محصول خود را به سبد خرید اضافه کند تمام مراحل خرید از جمله محاسبه قیمت، حمل و نقل و پرداخت به صورت انلاین
          محاسبه میشود و میوانید به راحتی محصولتان را خریداری کنید.
        </p>
      </div>
      <div className="mt-14">
