...
function ShoppingTraining() {
  return (
    <div className="container mt-28">
      ...
      <div class="max-md:text-sm md:text-lg text-gray-600">
        <p>
        ...
        <p>
          ...
          خرید اضافه کند تمام مراحل خرید از جمله محاسبه قیمت، حمل و نقل و پرداخت به صورت انلاین محاسبه میشود و میوانید
          به راحتی محصولتان را خریداری کنید.
        </p>
      </div>
      <div class="mt-14">
