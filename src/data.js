...
export const orderDetailData = {
  ...
  productsProgress: [
    {
      ...
      timelineSteps: [
        { id: "order", label: "ثبت سفارش", Icon: DocumentText },
        { id: "payment", label: "پرداخت موفق", Icon: Wallet },
  ...
  media: [
    { type: "video", url: "/videos/product1.mp4", thumbnail: "/images/products/ps5-video.jpg" },
    { type: "image", url: "/images/products/ps5-1.jpg" },
    { type: "image", url: "/images/products/ps5-2.jpg" },
    { type: "image", url: "/images/products/ps5-3.jpg" },
    { type: "image", url: "/images/products/ps5-4.jpg" },
  ],
  trackingCodes: [
    {
